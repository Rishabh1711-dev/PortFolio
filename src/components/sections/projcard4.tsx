...
export function ProjCard4() {
  return (
    <a 
      href="https://github.com/Rishabh1711-dev/MusicProject" 
      target="_blank" 
    ...
    >
      ...
      <div className="w-full h-full flex flex-col justify-between z-10">
        <EvervaultCard
          title="Melody Mastery – Premium Music Learning Platform"
          description="A modern music learning management system featuring interactive courses, student dashboards, secure authentication, GraphQL APIs, Redis caching, and PostgreSQL-backed content management built with Next.js."
          image="https://res.cloudinary.com/dtwjc8gng/image/upload/v1782029031/Screenshot_2026-06-21_133259_tdyrvc.png" 
        />
      </div>
    </a>
  );
