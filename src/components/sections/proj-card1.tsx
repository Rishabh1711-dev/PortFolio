...
export function ProjCard1() {
  return (
    <a 
      href="https://d3kzce052rnsgm.cloudfront.net/" 
      target="_blank" 
    ...
    >
      ...
      <div className="w-full h-full flex flex-col justify-between z-10">
        <EvervaultCard
          title="GetPlaced – AI Placement Preparation Platform"
          description="An AI-powered career preparation platform that helps students crack placements through ATS resume analysis, mock interviews, coding preparation, analytics dashboards, and personalized learning roadmaps. Built with Next.js, TypeScript, OpenAI API, MongoDB, and AWS."
