  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex flex-col justify-between z-10">
        <EvervaultCard
          title="TATA Group - Intern"
          description="Leveraged exploratory data analysis, predictive modeling, and AI-driven insights to identify business opportunities, assess risks, and support strategic decision-making."
          image="https://res.cloudinary.com/dtwjc8gng/image/upload/v1782027497/Screenshot_2026-06-21_130736_uunjh7.png" 
        />
      </div>
    </a>
  );
