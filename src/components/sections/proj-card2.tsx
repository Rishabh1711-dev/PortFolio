...
export function ProjCard2() {
  return (
    <a 
      href="https://mystery-mu.vercel.app/" 
      target="_blank" 
    ...
    >
      ...
      <div className="w-full h-full flex flex-col justify-between z-10">
        <EvervaultCard
          title="Unspoken – Anonymous Messaging & AI Feedback Platform"
          description="A privacy-first feedback platform enabling users to send and receive anonymous messages securely. Features AI-generated conversation starters, authentication, email integration, and a modern interactive UI powered by Gemini AI and Next.js."
          image="https://res.cloudinary.com/dtwjc8gng/image/upload/v1782028417/Screenshot_2026-06-21_132148_y5dtgs.png" 
        />
      </div>
    </a>
  );
