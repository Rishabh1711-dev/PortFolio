...
export function ProjCard3() {
  return (
    <a 
      href="https://main.d37uq7vinp3lks.amplifyapp.com/" 
      target="_blank" 
    ...
    >
      ...
      <div className="w-full h-full flex flex-col justify-between z-10">
        <EvervaultCard
          ...
          description="A full-stack learning ecosystem where users can exchange skills, connect with mentors, discover courses, and collaborate through a community-driven platform. Integrated with an AI assistant for personalized learning support."
          image="https://res.cloudinary.com/dtwjc8gng/image/upload/v1782028413/Screenshot_2026-06-21_132255_pnorrx.png" 
        />
      </div>
    </a>
  );
